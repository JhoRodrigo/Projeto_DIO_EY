...
__all__ = [
    'SDTAudio', 'SVP_5', 'ISpeechFileStream',
    'DISPID_SVAudioOutputStream', 'DISPID_SRCCreateResultFromMemory',
    'SAFTExtendedAudioFormat', 'SAFT48kHz16BitStereo', 'SPRS_ACTIVE',
    'DISPID_SMSALineId', 'SpSharedRecognizer', 'DISPID_SPAs_NewEnum',
    'SP_VISEME_9', 'DISPID_SOTCreateInstance',
    ...
    'SpNullPhoneConverter', 'SGDisplay', 'DISPID_SpeechObjectTokens',
    'ISpNotifySink', 'SVSFPurgeBeforeSpeak', 'IStream', 'SLOStatic',
    'SPPS_RESERVED4', 'SpeechFormatType', 'SpeechMicTraining',
    'DISPID_SPACommit', 'DISPID_SPEsCount', 'ISpRecoContext2',
    'SRSEIsSpeaking', 'SSSPTRelativeToEnd', 'SREHypothesis',
    'ISpXMLRecoResult', 'SPPS_RESERVED1', 'SREBookmark',
    ...
    'SpResourceManager', 'SPWF_INPUT', 'DISPID_SRCSetAdaptationData',
    'SGRSTTDictation', 'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SGRsFindRule', 'SVSFParseSsml', 'SAFTGSM610_22kHzMono',
    'DISPID_SPEAudioTimeOffset', 'SpeechLexiconType',
    'SAFT48kHz8BitMono', 'SGDSInactive', 'DISPID_SAFGetWaveFormatEx',
    'SpShortcut', 'DISPID_SMSSetData',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SRCVoice',
    'ISpeechObjectTokenCategory', 'SpeechVoiceEvents',
    'SPSHORTCUTPAIRLIST', 'SPAS_RUN', 'SPEI_UNDEFINED',
    'SAFTCCITT_ALaw_22kHzStereo',
    'DISPID_SpeechGrammarRuleStateTransition', 'DISPID_SPPChildren',
    'SVP_9', 'SPRULE', 'ISpeechGrammarRuleStateTransition',
    'eLEXTYPE_RESERVED8', 'DISPID_SOTMatchesAttributes',
    'SVSFVoiceMask', 'SREStreamStart', 'DISPID_SGRSTNextState',
    'SBOPause', 'SP_VISEME_1', 'SAFTCCITT_uLaw_8kHzStereo',
    'SPXMLRESULTOPTIONS', 'SpeechAudioVolume', 'SRSActiveAlways',
    'SpNotifyTranslator', 'SSFMOpenReadWrite',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SRRTimes',
    'ISpeechXMLRecoResult', 'DISPID_SLPsCount',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SpeechVoiceEvent',
    'SPPS_Verb', 'SREInterference', 'STCInprocServer',
    'ISpeechMMSysAudio', 'SRERecognition',
    'DISPID_SVSLastStreamNumberQueued',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SRGDictationSetState',
    'DISPID_SRSNumberOfActiveRules', 'SPEI_HYPOTHESIS',
    'DISPID_SPPBRestorePhraseFromMemory', 'DISPID_SVGetAudioInputs',
    'ISpeechObjectTokens', 'ISpeechPhraseAlternates',
    'SPBINARYGRAMMAR', 'Speech_Default_Weight', 'SP_VISEME_18',
    'DISPID_SpeechPhraseProperty', 'DISPID_SRRGetXMLResult',
    'DISPID_SVSLastBookmark', '__MIDL_IWinTypes_0009',
    'SPEI_START_SR_STREAM', 'DISPID_SRGIsPronounceable',
    'DISPID_SASCurrentSeekPosition', 'ISpLexicon', 'SPWAVEFORMATTYPE',
    'SP_VISEME_3', 'SpeechPropertyComplexResponseSpeed',
    'DISPID_SGRSTWeight', 'DISPID_SPAsCount', 'SPSHT_EMAIL',
    ...
    'SPEI_SR_RETAINEDAUDIO', 'ISpeechDataKey', 'DISPID_SGRAttributes',
    'STSF_AppData', 'DISPID_SVSInputWordLength', 'SVEAllEvents',
    'DISPID_SpeechVoice', 'SPINTERFERENCE', 'SPEI_START_INPUT_STREAM',
    'SpeechDiscardType', 'SAFT16kHz16BitMono', 'DISPID_SVEViseme',
    'DISPID_SOTRemove', 'SAFT16kHz8BitStereo',
    'DISPID_SOTCGetDataKey', 'SPEI_TTS_PRIVATE', 'DISPID_SBSRead',
    'DISPID_SAEventHandle', 'DISPID_SRSCurrentStreamPosition',
    'ISpeechLexiconPronunciations', 'eLEXTYPE_PRIVATE12',
    'SAFTCCITT_ALaw_8kHzMono', 'SPEI_VOICE_CHANGE', 'DISPID_SLPsItem',
    'DISPID_SPEDisplayText', 'DISPID_SPEEngineConfidence',
    'SAFT48kHz8BitStereo', 'SpeechVisemeType',
    'ISpeechRecoResultDispatch', 'SAFTGSM610_11kHzMono', 'SGSEnabled',
    'SPDATAKEYLOCATION', 'ISpStreamFormat', 'DISPID_SAVolume',
    ...
    'ISpMMSysAudio', 'SDA_No_Trailing_Space', 'DISPID_SGRsCount',
    'STCLocalServer', 'eLEXTYPE_PRIVATE20', 'eLEXTYPE_RESERVED4',
    'DISPID_SOTGetAttribute', 'SPEVENT', 'DISPID_SGRsAdd',
    'SPPS_RESERVED2', 'SP_VISEME_21', 'DISPID_SRAudioInput',
    'SDKLCurrentConfig', 'SPWORD', 'SVEBookmark',
    'DISPID_SRRTOffsetFromStart', 'SREAllEvents',
    'DISPID_SPEs_NewEnum', 'DISPID_SWFEBitsPerSample',
    'SPVPRI_NORMAL', 'DISPID_SPILanguageId', 'DISPID_SPRules_NewEnum',
    'DISPID_SRGCmdLoadFromMemory', 'DISPID_SOTs_NewEnum', 'ISpPhrase',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SVPriority',
    'DISPID_SRCVoicePurgeEvent', '_RemotableHandle',
    'DISPID_SPPEngineConfidence', 'DISPID_SPPsCount',
    'ISpPhoneticAlphabetSelection', 'SPSERIALIZEDPHRASE',
    'ISpRecoResult', 'SPRECOCONTEXTSTATUS', 'SRCS_Enabled',
    'SPPS_SuppressWord', 'SVP_12', 'tagSTATSTG',
    'DISPID_SDKDeleteValue', 'SVESentenceBoundary', 'eLEXTYPE_APP',
    'SpeechRuleState', 'SPRST_ACTIVE_ALWAYS', 'DISPID_SPPId',
    'SVP_17', 'SVF_Emphasis', 'SPPS_RESERVED3', 'DISPID_SAStatus',
    'DISPID_SRCCmdMaxAlternates', 'SAFTCCITT_ALaw_11kHzStereo',
    'SAFT44kHz16BitStereo', 'SASStop', 'SSTTWildcard',
    'SPEI_SOUND_END', 'DISPID_SLWLangId', 'SpeechEngineProperties',
    'DISPID_SpeechObjectToken', 'SP_VISEME_20',
    'SAFT22kHz16BitStereo', 'SPPS_NotOverriden', 'SVP_20', 'SBONone',
    'DISPID_SVEStreamStart', 'DISPID_SPEDisplayAttributes',
    'ISpeechLexiconWords', 'SRSInactiveWithPurge',
    'DISPID_SVEventInterests', 'SRCS_Disabled', 'ISpeechRecognizer',
    'DISPID_SVESentenceBoundary', 'SGRSTTWord',
    'SSSPTRelativeToCurrentPosition', 'SVEWordBoundary',
    'DISPID_SGRSTransitions', 'eLEXTYPE_PRIVATE15', 'SVPNormal',
    'SpMMAudioEnum', 'ISpeechPhraseAlternate', 'SAFT44kHz8BitMono',
    'SPINTERFERENCE_NONE', 'SPFM_CREATE_ALWAYS', 'SVSFIsNotXML',
    'SPVPRI_ALERT', 'DISPID_SLGetPronunciations',
    'DISPID_SVSLastResult', 'SpMMAudioIn', 'SPEI_RECO_OTHER_CONTEXT',
    'SVP_4', 'SVP_3', 'SPINTERFERENCE_TOOQUIET', 'SPEI_MAX_SR',
    'ISpeechRecoGrammar', 'SWPUnknownWordPronounceable',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SRCEStartStream',
    'DISPID_SRRTTickCount', 'DISPID_SMSGetData', 'STSF_CommonAppData',
    'DISPID_SRCCreateGrammar', 'SAFT8kHz16BitMono', 'WAVEFORMATEX',
    'DISPID_SPRulesCount', 'SpeechRegistryUserRoot',
    'SSFMCreateForWrite', 'DISPID_SRRTLength', 'DISPID_SVSpeak',
    'DISPID_SPPName', 'SRSActive', 'SAFT24kHz16BitMono',
    'SPAS_CLOSED', 'SpeechRetainedAudioOptions',
    'DISPID_SWFEFormatTag', 'DISPID_SRRPhraseInfo',
    'DISPID_SpeechVoiceStatus', 'DISPID_SPPConfidence',
    'DISPID_SPRs_NewEnum', 'DISPID_SDKEnumKeys',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SPANumberOfElementsInResult', 'SVSFlagsAsync',
    'DISPID_SLPSymbolic', 'SAFT32kHz8BitMono', 'DISPID_SDKDeleteKey',
    'SP_VISEME_6', 'DISPID_SVSVisemeId', 'ISpeechCustomStream',
    'ISpeechPhraseRule', 'SPEI_RECO_STATE_CHANGE',
    'SPPHRASEREPLACEMENT', '_ISpeechVoiceEvents',
    'DISPID_SRDisplayUI', 'DISPID_SRCERequestUI',
    'DISPID_SPCIdToPhone', 'DISPID_SOTGetDescription',
    'DISPID_SVWaitUntilDone', 'SDKLDefaultLocation',
    'DISPID_SpeechMMSysAudio', 'SLTUser', 'ISpRecognizer2',
    'SpeechTokenIdUserLexicon', 'DISPID_SPEsItem',
    'SAFT44kHz16BitMono', 'DISPID_SOTCSetId', 'DISPID_SGRsItem',
    'eLEXTYPE_MORPHOLOGY', 'SAFT8kHz8BitStereo',
    'SpeechRecognizerState', 'SPLOADOPTIONS', 'STCRemoteServer',
    'SpUnCompressedLexicon', 'SpeechVisemeFeature', 'SPBO_PAUSE',
    'DISPID_SGRsCommitAndSave', 'SAFTCCITT_uLaw_44kHzMono',
    'SITooQuiet', 'DISPID_SpeechPhraseElement',
    'SpObjectTokenCategory', 'SPRS_ACTIVE_USER_DELIMITED',
    'SPAUDIOBUFFERINFO', 'DISPID_SpeechPhoneConverter',
    'Speech_StreamPos_RealTime', 'DISPID_SPIElements', 'SPVISEMES',
    'DISPID_SRRTStreamTime', 'SPSLMA', 'DISPID_SpeechMemoryStream',
    'DISPID_SRStatus',
    ...
    'SPDKL_LocalMachine', 'DISPID_SFSClose',
    'DISPID_SRGetPropertyString', 'DISPID_SGRAddResource',
    'SPWF_SRENGINE', 'SpeechPropertyResponseSpeed', 'SPEVENTENUM',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SGRSAddSpecialTransition',
    'DISPID_SVDisplayUI', 'SAFT16kHz8BitMono',
    'SREPropertyStringChange', 'SGDSActive', 'ISpStream',
    'DISPIDSPTSI_SelectionLength', 'SDTPronunciation',
    'DISPID_SLAddPronunciationByPhoneIds', 'SAFTNoAssignedFormat',
    'SPTEXTSELECTIONINFO', 'eLEXTYPE_PRIVATE14', 'SVSFIsXML',
    'DISPID_SLPs_NewEnum', 'SGPronounciation', 'SVSFParseSapi',
    'DISPID_SABufferNotifySize', 'DISPID_SRCRequestedUIType',
    'SPEVENTSOURCEINFO', 'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SPEI_VISEME', 'SPFM_OPEN_READWRITE', 'tagSPTEXTSELECTIONINFO',
    'DISPID_SRGId', 'DISPID_SPERetainedSizeBytes', 'DISPIDSPTSI',
    'DISPID_SPPsItem', 'SAFT22kHz16BitMono', 'DISPID_SGRSTsCount',
    'SPSFunction', 'DISPID_SPIProperties',
    'DISPID_SpeechRecognizerStatus', 'SpeechVoiceSkipTypeSentence',
    'ISpRecoContext', 'DISPID_SVEPhoneme', 'SECFEmulateResult',
    'SpeechAudioState', 'DISPID_SpeechPhraseRules', 'eWORDTYPE_ADDED',
    'eLEXTYPE_PRIVATE18', 'SAFTCCITT_uLaw_11kHzStereo',
    'SAFT24kHz8BitMono', 'SP_VISEME_14', 'SpeechStreamFileMode',
    'DISPID_SOTIsUISupported', 'SPCATEGORYTYPE', 'SPEI_PHRASE_START',
    'SPDKL_DefaultLocation',
    'DISPID_SpeechGrammarRuleStateTransitions', 'eLEXTYPE_RESERVED6',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SP_VISEME_15',
    'SPFILEMODE', 'DISPID_SVStatus', 'SpeechRunState',
    'SPSHORTCUTTYPE', 'SpPhoneConverter', 'SPGS_EXCLUSIVE',
    'SPPROPERTYINFO', 'SECLowConfidence', 'DISPID_SpeechRecoResult2',
    'SECFIgnoreKanaType', 'SpeechEngineConfidence',
    'DISPID_SBSFormat', 'SVP_11', 'SAFTGSM610_44kHzMono',
    'SPPS_Unknown', 'DISPID_SGRs_NewEnum', 'SPSERIALIZEDRESULT',
    'SPEI_END_SR_STREAM', 'SPWORDPRONUNCIATIONLIST',
    'eLEXTYPE_PRIVATE7', 'DISPID_SBSWrite', 'DISPID_SOTSetId',
    'SpeechRecognitionType', 'SpeechCategoryRecognizers', 'SLTApp',
    'ISpObjectWithToken', 'SPRECOSTATE', 'SPWT_LEXICAL',
    'Speech_StreamPos_Asap', 'SPPS_Noun',
    'DISPIDSPTSI_SelectionOffset', 'SPGS_ENABLED',
    'SPCT_SUB_DICTATION', 'SPRST_NUM_STATES',
    'DISPID_SRCEEnginePrivate', 'SPSEMANTICERRORINFO',
    'DISPID_SGRSAddRuleTransition', 'ISpeechRecoContext',
    '_SPAUDIOSTATE', 'SPSHT_NotOverriden', 'ISpeechAudioBufferInfo',
    'SpeechWordPronounceable', 'SPEI_RESERVED2',
    'DISPID_SLRemovePronunciation', 'SPAO_NONE', 'SPEI_TTS_BOOKMARK',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SVSpeakCompleteEvent',
    'DISPID_SRSClsidEngine', 'DISPID_SVSpeakStream',
    'SPEI_SR_BOOKMARK', 'DISPID_SWFESamplesPerSec', 'IEnumString',
    'DISPID_SAFType', 'DISPID_SCSBaseStream', 'ISpeechAudioStatus',
    'Speech_Max_Pron_Length', 'SVF_None', 'DISPID_SOTDataKey',
    'SpeechAudioProperties', 'eLEXTYPE_PRIVATE10', 'SPAR_Unknown',
    'SP_VISEME_11', 'SVP_0', 'SVEPhoneme', 'ISpeechLexicon',
    ...
    'eLEXTYPE_PRIVATE4', 'ISpNotifyTranslator', 'SRTReSent',
    'DISPID_SVEStreamEnd', 'SP_VISEME_7', 'ISpRecoGrammar2',
    'eLEXTYPE_PRIVATE3', 'ISpeechGrammarRuleStateTransitions',
    'SpeechRuleAttributes', 'DISPID_SPEAudioSizeBytes', 'SPSVerb',
    'DISPID_SRGDictationUnload', 'DISPID_SRCEFalseRecognition',
    'DISPID_SOTCId', 'SVP_2', 'SRSInactive', 'SRSEDone',
    'DISPID_SPAPhraseInfo', 'DISPID_SpeechRecoResult', 'SGLexical',
    'SpeechInterference', 'SPXRO_Alternates_SML',
    'SPEI_END_INPUT_STREAM', 'DISPID_SRCRecognizer',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SDKSetStringValue',
    'ISpeechPhraseRules', 'STCInprocHandler',
    'SpeechGrammarTagUnlimitedDictation',
    'DISPID_SPRDisplayAttributes', 'ISpRecognizer', 'SPFM_CREATE',
    'SPRST_ACTIVE', 'SREStateChange', 'DISPID_SpeechPhraseProperties',
    'DISPID_SRIsShared', 'DISPID_SRRecognizer',
    'DISPID_SRSAudioStatus', 'DISPID_SVAudioOutput',
    'DISPID_SVEAudioLevel', 'SPPS_LMA', 'DISPID_SRRRecoContext',
    'SPLO_STATIC', 'SPPS_Function', 'DISPID_SLWPronunciations',
    'DISPID_SRGetFormat', 'SP_VISEME_8', 'DISPID_SRCBookmark',
    'SAFTADPCM_11kHzMono', 'DISPID_SpeechAudioStatus',
    'DISPID_SPIEnginePrivateData', 'SVP_6', 'SP_VISEME_12',
    'SpPhoneticAlphabetConverter', 'ISpeechPhraseElement',
    'SPEI_MAX_TTS', 'DISPID_SPIAudioStreamPosition',
    'DISPID_SRGetPropertyNumber', 'SPRULESTATE',
    'DISPID_SLRemovePronunciationByPhoneIds', 'eWORDTYPE_DELETED',
    'DISPIDSPRG', 'DISPIDSPTSI_ActiveLength',
    'DISPID_SRGetRecognizers', 'DISPID_SPRText',
    'DISPID_SPIStartTime', 'ISpShortcut', 'DISPID_SOTId',
    'SRATopLevel', 'SVEPrivate', 'eLEXTYPE_LETTERTOSOUND',
    'DISPID_SpeechPhraseElements', 'DISPID_SPRuleEngineConfidence',
    'SPAUDIOSTATUS', 'SVPAlert', '_ISpeechRecoContextEvents',
    'SDKLCurrentUser', 'DISPID_SpeechPhraseBuilder', 'SpWaveFormatEx',
    'DISPID_SWFEChannels', 'DISPID_SpeechDataKey', 'SGRSTTEpsilon',
    'ISpeechPhoneConverter', 'DISPID_SGRSTs_NewEnum',
    'SPPHRASEPROPERTY', 'DISPID_SLAddPronunciation',
    'SPSInterjection', 'SDA_One_Trailing_Space', 'SPWT_PRONUNCIATION',
    'SPEI_RESERVED6', 'SPEI_PHONEME', 'SWPUnknownWordUnpronounceable',
    'SPEI_RESERVED1', 'SpCustomStream', 'DISPID_SRCEBookmark',
    'DISPID_SRProfile', 'SPWORDPRONUNCIATION', 'SPRECOGNIZERSTATUS',
    'DISPID_SpeechPhraseRule', 'SVP_7', 'SPWT_DISPLAY',
    'DISPID_SGRSAddWordTransition', 'DISPID_SpeechLexiconProns',
    'SAFT32kHz16BitStereo', 'DISPID_SLWType', 'ISpPhraseAlt',
    'DISPID_SABIEventBias', 'DISPID_SLGetWords', 'SVP_21',
    'DISPID_SVEWord', 'DISPID_SLPType', 'SVP_18',
    'SPINTERFERENCE_NOISE', 'SPPS_Interjection', 'DISPID_SpeechAudio',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SGDSActiveWithAutoPause',
    'DISPID_SPRsCount', 'SPAS_PAUSE', 'SPSHT_OTHER',
    'DISPID_SRCERecognition', 'SRTAutopause',
    'SpeechCategoryAppLexicons', 'ISpEventSource',
    'SpeechTokenKeyFiles', 'SREPrivate', 'SVEVoiceChange',
    'SAFTDefault', 'DISPID_SOTGetStorageFileName',
    ...
    'SpeechDisplayAttributes', 'SFTSREngine', 'DISPID_SRCESoundEnd',
    'SAFT12kHz8BitMono', 'SGSDisabled', 'ISpeechRecoResult',
    'SPBO_TIME_UNITS', 'eLEXTYPE_RESERVED9', 'SpVoice',
    'DISPID_SpeechGrammarRule', 'SAFTText', 'SpeechCategoryVoices',
    'SVP_8', 'ISpeechGrammarRule', 'SPBOOKMARKOPTIONS', 'SPXRO_SML',
    'ISpeechPhraseInfo', 'DISPID_SRCEHypothesis',
    'DISPID_SOTCDefault', 'SpeechAudioFormatType',
    'DISPID_SpeechLexiconWords', 'SVPOver', 'SPPHRASE',
    'SAFTADPCM_44kHzMono', 'SINoise', 'DISPID_SRGSetWordSequenceData',
    ...
    'DISPID_SPPNumberOfElements', 'STCAll', 'SLODynamic',
    'SPRST_INACTIVE_WITH_PURGE', 'SP_VISEME_13',
    'SpInProcRecoContext', 'DISPID_SPRuleFirstElement',
    'DISPID_SLWsCount', 'SpeechGrammarTagWildcard', 'SPCT_COMMAND',
    'SAFTCCITT_ALaw_44kHzMono', 'DISPID_SLGetGenerationChange',
    'SDTAll', 'DISPID_SDKEnumValues', 'SPSHORTCUTPAIR',
    'SRESoundStart', 'eLEXTYPE_VENDORLEXICON', 'SRTEmulated',
    'SpeechSpecialTransitionType', 'DISPID_SpeechRecoContextEvents',
    'ISpRecoGrammar', 'DISPID_SRIsUISupported',
    'SpeechEmulationCompareFlags', 'SECFDefault', 'DISPID_SGRName',
    'SPFM_NUM_MODES', 'DISPID_SGRClear', 'SpeechRecoEvents',
    'SGRSTTRule', 'SDA_Consume_Leading_Spaces', 'SDTReplacement',
    'SpeechPropertyResourceUsage', 'SITooFast', 'UINT_PTR',
    'ISpeechVoiceStatus', 'SPSMF_SRGS_SAPIPROPERTIES', 'SPAR_Medium',
    'SPVOICESTATUS', 'DISPID_SASetState', 'SpeechCategoryAudioOut',
    'DISPID_SVPause', 'SPINTERFERENCE_TOOLOUD', 'ISpDataKey',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SPEActualConfidence',
    'SAFTADPCM_8kHzMono', 'SpeechVoiceCategoryTTSRate', 'LONG_PTR',
    'DISPID_SVAlertBoundary', 'DISPID_SDKGetlongValue',
    'DISPID_SFSOpen', 'ISpeechObjectToken', 'SPVPRIORITY',
    'SpeechTokenKeyAttributes', 'SpMemoryStream', 'DISPID_SPRsItem',
    'eLEXTYPE_PRIVATE1', 'eLEXTYPE_PRIVATE5', 'SP_VISEME_16',
    'DISPID_SPERequiredConfidence', 'ISpProperties',
    'SSFMOpenForRead', 'DISPID_SLPPhoneIds', 'ISpeechPhraseElements',
    'ISpGrammarBuilder', 'DISPID_SGRSTText', 'SPAS_STOP',
    'DISPID_SREmulateRecognition', 'SWTAdded', 'DISPID_SWFEExtraData',
    'DISPID_SPEPronunciation', 'SpeechVoicePriority',
    'SAFT11kHz8BitMono', 'ISpeechRecoResultTimes',
    'ISpSerializeState', 'SGDSActiveUserDelimited',
    'SpSharedRecoContext', 'SRAExport', 'STSF_LocalAppData',
    'DISPID_SOTsItem', 'ISequentialStream',
    'DISPID_SPRNumberOfElements', 'DISPID_SOTDisplayUI',
    'DISPID_SGRSTType', 'SPAR_Low', 'DISPID_SPRuleName',
    'SVSFDefault', 'SPRECORESULTTIMES', 'SVP_10',
    'DISPID_SDKSetBinaryValue', 'DISPID_SpeechLexiconWord', 'SINone',
    'ISpeechVoice', 'DISPID_SRGCmdSetRuleState',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'DISPID_SGRsCommit',
    'SPCS_DISABLED', 'DISPID_SpeechAudioFormat', 'ISpeechAudioFormat',
    'SPSNoun', 'SAFT12kHz16BitMono', 'SPSNotOverriden',
    'DISPID_SRGCommit', 'DISPID_SRRSpeakAudio', 'SREStreamEnd',
    'ISpeechPhraseReplacement', 'SPSModifier', 'DISPID_SRGRules',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SPIGetDisplayAttributes',
    'DISPID_SPARecoResult', 'SDTAlternates', 'SVSFParseMask',
    'SASClosed', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SAFTCCITT_ALaw_44kHzStereo', 'SAFTGSM610_8kHzMono',
    'DISPID_SDKGetStringValue', 'SVEAudioLevel', 'eLEXTYPE_USER',
    'SDTLexicalForm', 'ISpeechRecoResult2', 'SGSExclusive',
    'SINoSignal', 'DISPID_SRCEPropertyStringChange',
    'DISPID_SRRAlternates', 'SRAInterpreter',
    'SPINTERFERENCE_NOSIGNAL', 'ISpeechPhraseReplacements',
    'DISPID_SADefaultFormat', 'DISPID_SRCESoundStart',
    'DISPID_SpeechFileStream', 'SpeechRegistryLocalMachineRoot',
    'DISPID_SpeechPhraseAlternate', 'SRAImport', 'SRARoot',
    'DISPID_SVSInputWordPosition', 'eLEXTYPE_PRIVATE2',
    'ISpRecognizer3', 'DISPID_SOTsCount', 'DISPID_SVSLastBookmarkId',
    'DISPID_SRGCmdLoadFromResource', 'SP_VISEME_10', 'SP_VISEME_19',
    'DISPID_SRGCmdLoadFromFile', 'SAFT8kHz8BitMono',
    'SAFT24kHz16BitStereo', 'DISPID_SGRSTsItem',
    'SpTextSelectionInformation', 'SPRS_INACTIVE', 'SVSFIsFilename',
    'SPPHRASERULE', 'SREAudioLevel', 'SITooSlow', 'ISpAudio',
    ...
    'SpeechVoiceSpeakFlags', 'SDA_Two_Trailing_Spaces',
    'ISpEventSink', 'SSTTTextBuffer', 'SAFT22kHz8BitStereo',
    'SREAdaptation', 'SAFTADPCM_8kHzStereo', 'SPRST_INACTIVE',
    'SDTDisplayText', 'DISPID_SpeechPhraseInfo', 'SDTRule',
    'SPAR_High', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'SpeechGrammarState', 'SRTStandard', 'tagSPPROPERTYINFO',
    'DISPID_SLPPartOfSpeech', 'SPGS_DISABLED', 'DISPID_SPIRule',
    'ISpeechResourceLoader', 'ISpeechPhraseProperty',
    'SVSFNLPSpeakPunc', 'SpeechCategoryPhoneConverters',
    'SPFM_OPEN_READONLY', 'SVP_1', 'DISPID_SVIsUISupported',
    'DISPID_SpeechRecoContext', 'SVEEndInputStream',
    'DISPID_SRCEEndStream', 'SPEI_FALSE_RECOGNITION',
    'SVSFPersistXML', 'DISPID_SRCEAdaptation', 'SVP_15', 'SITooLoud',
    'ISpVoice', 'ISpeechGrammarRuleState', 'DISPID_SPPValue',
    ...
    'SAFTADPCM_11kHzStereo', 'SFTInput', 'STSF_FlagCreate',
    'DISPID_SVVolume', 'DISPID_SPISaveToMemory', 'DISPID_SRCPause',
    'SP_VISEME_4', 'SVSFNLPMask', 'SAFTADPCM_44kHzStereo',
    'SpeechAudioFormatGUIDWave', 'DISPID_SpeechBaseStream',
    'DISPID_SPAStartElementInResult', 'SPWORDTYPE',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SGRId', 'SPEI_SR_PRIVATE',
    'DISPID_SGRSRule', 'SPBO_AHEAD', 'DISPID_SAFGuid',
    'DISPID_SOTCEnumerateTokens', 'SAFTCCITT_uLaw_22kHzMono',
    'DISPID_SRRSetTextFeedback', 'SAFT8kHz16BitStereo',
    'eLEXTYPE_PRIVATE17', 'ISpResourceManager', 'SpeechWordType',
    'SPSSuppressWord', 'DISPID_SVRate', 'SPAO_RETAIN_AUDIO',
    'SAFT32kHz16BitMono', 'DISPID_SMSAMMHandle', 'SDTProperty',
    'SP_VISEME_5', 'DISPID_SLWWord', 'DISPID_SPIReplacements',
    'SAFTNonStandardFormat', 'DISPID_SABIMinNotification',
    'SECFIgnoreWidth', 'SPGRAMMARWORDTYPE',
    'DISPID_SpeechRecoResultTimes', 'SAFT12kHz8BitStereo',
    'SPSHT_Unknown', 'SPEI_SOUND_START', 'SREPhraseStart',
    'SRAORetainAudio', 'DISPID_SDKOpenKey', 'SPPS_Noncontent',
    'SASPause', 'SRTExtendableParse', 'SRTSMLTimeout',
    'SAFTCCITT_ALaw_11kHzMono', 'SPWORDLIST', 'SP_VISEME_17',
    'SPCT_SUB_COMMAND', 'DISPID_SVGetAudioOutputs',
    'SRADefaultToActive', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SPCLangId', 'DISPID_SRGRecoContext',
    'DISPID_SLWs_NewEnum', 'DISPID_SGRSTPropertyId',
    'SpeechAddRemoveWord', 'SAFTADPCM_22kHzMono',
    'SECNormalConfidence', 'SPCS_ENABLED', 'SECFNoSpecialChars',
    'eLEXTYPE_PRIVATE11', 'SPEI_MIN_SR', 'SGLexicalNoSpecialChars',
    'DISPID_SVGetVoices', 'SECHighConfidence', 'SGRSTTTextBuffer',
    'SPBO_NONE', 'SPAUDIOSTATE', 'DISPID_SRCState',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SRGReset', 'SVP_16',
    'SPEI_ADAPTATION', 'SpeechTokenShellFolder', 'DISPID_SPRuleId',
    'DISPID_SASCurrentDevicePosition',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SPCT_DICTATION', 'SVEViseme',
    'SSTTDictation', 'SDKLLocalMachine', 'DISPID_SABufferInfo',
    'DISPID_SMSADeviceId', 'ISpeechBaseStream',
    'DISPID_SPRuleChildren', 'DISPID_SpeechAudioBufferInfo',
    'SpeechUserTraining', 'DISPID_SDKSetLongValue',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SAFT11kHz8BitStereo',
    'eLEXTYPE_USER_SHORTCUT', 'SVP_19', 'DISPID_SpeechWaveFormatEx',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SVSkip',
    'SpeechAudioFormatGUIDText', 'SPPARTOFSPEECH', 'DISPID_SRCResume',
    'SpeechRecoContextState', 'SPEI_MIN_TTS', 'DISPID_SPPs_NewEnum',
    'eLEXTYPE_PRIVATE16', 'DISPID_SBSSeek', 'SPSUnknown',
    'SpFileStream', 'SpeechGrammarRuleStateTransitionType', 'SVP_14',
    'DISPID_SPRuleConfidence', 'SASRun', 'SPEI_INTERFERENCE',
    'DISPID_SPIAudioSizeTime', 'SAFT12kHz16BitStereo',
    'SpStreamFormatConverter', 'SPSMF_UPS',
    'SPEI_PROPERTY_STRING_CHANGE', 'eLEXTYPE_PRIVATE19',
    'DISPID_SVSInputSentencePosition', 'DISPID_SASFreeBufferSpace',
    'SPGRAMMARSTATE', 'ISpeechPhraseProperties',
    'SpeechDataKeyLocation', 'SpeechTokenKeyUI', 'SP_VISEME_0',
    'IInternetSecurityManager', 'DISPID_SASState',
    'SPDKL_CurrentUser', 'SPCONTEXTSTATE', 'DISPID_SASNonBlockingIO',
    'SpObjectToken', 'SpeechPropertyNormalConfidenceThreshold',
    'SPCT_SLEEP', 'ISpObjectTokenCategory', 'SAFT11kHz16BitMono',
    'ISpRecoCategory', 'DISPID_SPIGetText', 'SPVPRI_OVER', 'SpStream',
    'SPSMF_SAPI_PROPERTIES', 'SRERequestUI', 'DISPID_SRCEAudioLevel',
    'eLEXTYPE_PRIVATE6', 'DISPID_SRState',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SPPS_Modifier',
    'DISPID_SVEEnginePrivate', 'SPINTERFERENCE_TOOFAST', 'SRAONone',
    'DISPID_SpeechCustomStream', 'ISpeechPhraseInfoBuilder',
    'DISPID_SPCPhoneToId', 'SPSTREAMFORMATTYPE',
    'SAFT24kHz8BitStereo', 'eLEXTYPE_PRIVATE13',
    'SPADAPTATIONRELEVANCE', 'DISPID_SRRAudioFormat',
    'DISPID_SRRSaveToMemory', 'eLEXTYPE_PRIVATE8', 'SPEI_REQUEST_UI',
    'DISPID_SPRulesItem', 'SPPHRASEELEMENT', 'ISpPhoneConverter',
    'SAFT11kHz16BitStereo', 'SWTDeleted', 'DISPID_SVGetProfiles',
    ...
    'SpeechGrammarWordType', 'DISPID_SRCEventInterests', 'SVP_13',
    'SpCompressedLexicon', 'DISPID_SVSCurrentStreamNumber',
    'SpeechCategoryAudioIn', 'DISPID_SLPLangId', 'SpeechAllElements',
    'SpeechStreamSeekPositionType', 'DISPID_SDKGetBinaryValue',
    'SRESoundEnd', 'SpLexicon', 'DISPID_SPRFirstElement',
    'SPEI_RESERVED3', 'SAFT16kHz16BitStereo', 'ISpeechWaveFormatEx',
    'DISPID_SpeechGrammarRules', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SSFMCreate', 'DISPID_SRCEInterference', 'SpeechTokenValueCLSID',
    'DISPID_SVSPhonemeId', 'SECFIgnoreCase',
    'DISPID_SPEAudioSizeTime', 'SPEI_RESERVED5', 'SPAUDIOOPTIONS',
    'DISPID_SVVoice', 'eLEXTYPE_PRIVATE9', 'DISPID_SGRSTRule',
    'DISPID_SLGenerationId', 'DISPID_SVSInputSentenceLength',
    'ISpObjectToken', 'SPLO_DYNAMIC', 'DISPID_SpeechLexicon',
    'DISPID_SRRAudio', 'SPWORDPRONOUNCEABLE', 'ISpeechMemoryStream',
    'DISPID_SRRGetXMLErrorInfo', 'SAFT48kHz16BitMono',
    'SPSEMANTICFORMAT', 'SAFT44kHz8BitStereo', 'SREPropertyNumChange',
    ...
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SPIGrammarId',
    'ISpeechLexiconWord', 'DISPID_SRSSupportedLanguages',
    'SVF_Stressed', 'DISPID_SPRuleParent',
    ...
    'DISPID_SOTCategory', 'SREFalseRecognition', 'DISPID_SPAsItem',
    'SpAudioFormat', 'DISPID_SPPFirstElement',
    'SpeechPropertyAdaptationOn', 'DISPID_SpeechLexiconPronunciation'
]

_check_version('1.1.14', 1655997255.715536)
